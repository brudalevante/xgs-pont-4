...
cd ..
git clone https://github.com/brudalevante/led-mtk-6.6.100.git mtk-openwrt-feeds || true
...
git clone --depth=1 --single-branch --branch master https://github.com/brudalevante/fakemesh-6g.git tmp_comxwrt
