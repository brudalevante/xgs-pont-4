...
git clone --branch openwrt-24.10 https://github.com/brudalevante/openwrt-2.git.git openwrt || true
cd openwrt; git checkout 00de48987cbd3b22717d29b0c1212353bf56e3e4; cd -;	# uhttpd: update to Git HEAD (2025-07-06)
